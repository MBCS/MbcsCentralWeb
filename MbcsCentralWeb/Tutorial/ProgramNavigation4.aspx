...
<asp:Content ID="Content3" ContentPlaceHolderID="BoxContent" runat="server">
    ...
    <a href="ProgramNavigation5.aspx" style="float:right; margin-top:-21px; border:solid 2px; background-color:aliceblue" runat="server">NEXT</a> 
    <br />
    ...
    <a href="ProgramNavigation5.aspx" style="float:right; border:solid 2px; background-color:aliceblue" runat="server">NEXT</a> 
</asp:Content>
