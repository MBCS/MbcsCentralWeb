<%@ Page Title="About Us" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="MbcsCentralWeb.About" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h3 style="text-align:center; color:blue;">Michael Bartmon Computer Services</h3>
    <div style="margin-left:20px; margin-right:20px">
    <p >	           
        Michael Bartmon Computer Services (MBCS) is a full-service computer consulting, programming and support company that has been providing computer solutions for businesses for over 
        ...
        <br /><br/>Mike has consulted for manufacturing, service, mail-order and distribution companies, as well as others.&nbsp; He has provided basic accounting software as well as highly specialized order processing, list rental processing, payroll, and property management systems.&nbsp; He has installed computers and networking hardware and software and trained non-computer people to operate all of the systems he has installed.
        <br/><br/>As both a consultant and a corporate systems person, Mike has worked with business owners, executives, programmers and clerical personnel.&nbsp; He is able to take a wish-list and turn it into a system.
    </p>
        </div>
</asp:Content>
